...
export const SLA = () => {
  return <section id="sla" className="py-20 md:py-32">
      <div className="container-custom">
        <motion.div className="glass-card rounded-3xl p-8 md:p-16" initial={{
        opacity: 0,
        y: 50
      }} whileInView={{
        opacity: 1,
        ...
        duration: 0.6
          ...
          <motion.div className="text-center max-w-3xl mx-auto mb-12 md:mb-16" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {slaItems.map((item, i) => <motion.div key={item.title} className="text-center p-8 rounded-2xl bg-background/50 border border-border/20 hover:border-primary/30 transition-all" initial={{
            opacity: 0,
            y: 40,
            scale: 0.95
          }} whileInView={{
