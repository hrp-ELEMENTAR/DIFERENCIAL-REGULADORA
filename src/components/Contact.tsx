...
const contactInfo = [
  { icon: Phone, label: "WhatsApp", value: "(45) 99998-1551", href: getWhatsAppLink() },
  { icon: Mail, label: "E-mail", value: "contato@diferencialreguladora.com.br", href: "mailto:contato@diferencialreguladora.com.br" },
  { icon: MapPin, label: "Site", value: "www.diferencialreguladora.com.br", href: "https://www.diferencialreguladora.com.br" },
];
    ...
    <section id="contato" className="py-16 md:py-24">
      <div className="container-custom">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <span className="pill mb-4">Vamos Conversar</span>
          ...
          >
            <div className="glass-card rounded-2xl p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Textarea 
                  name="msg" 
                  placeholder="Descreva sua necessidade: quantidade de veículos, regiões de atuação, tipo de frota, urgências..." 
                  required 
